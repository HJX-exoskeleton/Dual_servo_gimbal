...
Motor2 = Motor(DM_Motor_Type.DM4310, 0x02, 0x11)
...
MotorControl2 = MotorControl(serial_device)
...
# 读取并打印电机的子版本号参数
print("sub_ver:", MotorControl2.read_motor_param(Motor2, DM_variable.sub_ver))

# 读取并打印电机的减速比参数
print("Gr:", MotorControl2.read_motor_param(Motor2, DM_variable.Gr))
...
while i < 10000:
    ...
    MotorControl2.control_pos_force(Motor2, 0, 5000,300)
